...
hyp_params = args
hyp_params.orig_d_l, hyp_params.orig_d_a, hyp_params.orig_d_v = 145, 74, 129
# 65, 226, 145, 74, 129
...
def train_model(settings, hyp_params, train_loader, val_loader, test_loader):
    ...
    def equal_mean(view1, view2, view3, batch_Z, net):
        ...
        support_feature_view1, support_feature_view2, support_feature_view3, support_feature_mean, support_feature_cross = net(support_view1, support_view2, support_view3)
        query_feature_view1, query_feature_view2, query_feature_view3, query_feature_mean, query_feature_cross = net(query_view1, query_view2, query_view3)
    ...
    def train(model, optimizer, epoch, criterion):
        ...
        for [i_batch, (batch_X1, batch_X2, batch_X3, batch_X4, batch_X5, batch_Z)] in enumerate(train_loader):
            ...
            preds, query_label, cross_loss = equal_mean(batch_X3, batch_X4, batch_X5, batch_Z, net)
            ...
            if epoch <= pre_epoch:
                ...
                raw_loss = ((hyp_params.alpha_1 + 1) * view_1_loss + (hyp_params.alpha_2 + 1) * view_2_loss + (hyp_params.alpha_3 + 1) *
                            view_3_loss) / (hyp_params.alpha_1 + hyp_params.alpha_2 + hyp_params.alpha_3 + 3)
                ...
                raw_loss = (raw_loss + hyp_params.alpha_1 * view_1_loss + hyp_params.alpha_2 * view_2_loss + hyp_params.alpha_3 * view_3_loss) / (
                        1 + hyp_params.alpha_1 + hyp_params.alpha_2 + hyp_params.alpha_3)
            ...
            for [i_batch, (batch_X1, batch_X2, batch_X3, batch_X4, batch_X5, batch_Z)] in enumerate(loader):
                ...
                if epoch <= pre_epoch:
                    ...
                    raw_loss = (raw_loss + hyp_params.alpha_1 * view_1_loss + hyp_params.alpha_2 * view_2_loss + hyp_params.alpha_3 *
                                view_3_loss) / (1 + hyp_params.alpha_1 + hyp_params.alpha_2 + hyp_params.alpha_3)
    ...
    for epoch in range(1, hyp_params.num_epochs + 1):
        ...
        print(
            'Epoch {:2d} | Time {:5.4f} sec | Train Loss {:5.4f} | Valid Loss {:5.4f} | Test Loss {:5.4f}'.format(epoch,
                                                                                                                  ...
                                                                                                                  test_loss))
        print(
            'train:   |  Accuracy_view1 {:5.4f} | Accuracy_view2 {:5.4f} | Accuracy_view3 {:5.4f} |  Accuracy_gap {:5.4f} | Accuracy_att {:5.4f} | Accuracy_co {:5.4f} |'.format(
                Acc_view1_train,  Acc_view2_train, Acc_view3_train, Acc_gap_train,  Acc_weight_train, Acc_co_train))
        print(
            'val:     |  Accuracy_view1 {:5.4f} | Accuracy_view2 {:5.4f} | Accuracy_view3 {:5.4f} |  Accuracy_gap {:5.4f} | Accuracy_att {:5.4f} | Accuracy_co {:5.4f} |'.format(
                Acc_view1_val,  Acc_view2_val, Acc_view3_val,  Acc_gap_val,  Acc_weight_val, Acc_co_val))
        print(
            'test:    |  Accuracy_view1 {:5.4f} | Accuracy_view2 {:5.4f} | Accuracy_view3 {:5.4f} |  Accuracy_gap {:5.4f} | Accuracy_att {:5.4f} | Accuracy_co {:5.4f} |'.format(
    ...
    Acc_view1_test, Acc_view2_test,  Acc_gap_test, Acc_weight_test,Acc_co_test  = 0, 0, 0, 0, 0
    num_test = 100
    for epoch_test in range(num_test):
    ...
    print(
        ...
        ' |  Accuracy_view1 {:5.4f} | Accuracy_view2 {:5.4f} | Accuracy_view2 {:5.4f} |  Accuracy_gap {:5.4f} | Accuracy_att {:5.4f} | Accuracy_co {:5.4f} |'.format(
