...
hyp_params = args
hyp_params.orig_d_1, hyp_params.orig_d_2, hyp_params.orig_d_3, hyp_params.orig_d_4, hyp_params.orig_d_5 = 48, 254, 1984, 512, 928
...
def train_model(settings, hyp_params, train_loader, val_loader, test_loader):
    ...
    def train(model, optimizer, epoch, criterion):
        ...
        for [i_batch, (batch_X1, batch_X2, batch_X3, batch_X4, batch_X5, batch_X6, batch_Z)] in enumerate(train_loader):
            ...
            preds, query_label, cross_loss = equal_mean(batch_X1, batch_X3, batch_X4, batch_X5, batch_X6, batch_Z, net)
