...
def test_model(settings, hyp_params, test_loader):
    ...
    def equal_mean(view1, view2, view3, view4, batch_Z, net):
        ...
        support_feature_view1, support_feature_view2, support_feature_view3, support_feature_view4 = \
        ...
        query_feature_view1, query_feature_view2, query_feature_view3, query_feature_view4 = \
            query_feature_view1.cpu().numpy(), query_feature_view2.cpu().numpy(), \
            query_feature_view3.cpu().numpy(), query_feature_view4.cpu().numpy()
        ...
        pred_5 = clf.predict_proba(query_feature_mean)
        ...
        pred_6 = clf.predict_proba(query_feature_cross)

        pred_7 = (pred_1 + pred_2 + pred_3 + pred_4) / 4
    ...
    def evaluate(model, criterion, test=False):
        ...
        with torch.no_grad():
            for [i_batch, (batch_X1, batch_X2, batch_X3, batch_X4, batch_X5, batch_X6, batch_Z)] in enumerate(loader):
                ...
                net = model
                results, truths = equal_mean(batch_X3, batch_X4, batch_X5, batch_X6, batch_Z, net)
            ...
            Acc_mean = acc(preds[:, :, 4], label, True)
            Acc_cross = acc(preds[:, :, 5], label, True)
            ...
            print('all task in test: \n'
                  ' |  Accuracy_view1 {:5.4f} | Accuracy_view2 {:5.4f} | Accuracy_view3 {:5.4f} | Accuracy_view4 {:5.4f} |  Accuracy_gap {:5.4f} | Accuracy_cross {:5.4f} | Accuracy_co {:5.4f} |'.format(
                Acc_view1, Acc_view2, Acc_view3, Acc_view4, Acc_mean, Acc_cross, Acc_co))
            print(
                'improvment: \n'
