...
def test_model(settings, hyp_params, test_loader):
    ...
    def equal_mean(view1, view2, view3, batch_Z, net):
        ...
        support_feature_mean, query_feature_mean = support_feature_mean.view(shot * n_class, -1).cpu().numpy(), query_feature_mean.cpu().numpy()
    ...
    def evaluate(model, criterion, test=False):
        ...
        with torch.no_grad():
            for [i_batch, (batch_X1, batch_X2, batch_X3, batch_X4, batch_X5, batch_Z)] in enumerate(loader):
                ...
                net = model
                results, truths = equal_mean(batch_X3, batch_X4, batch_X5, batch_Z, net)
